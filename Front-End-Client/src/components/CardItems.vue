<template>
  <div
    class="bg-gray-100 min-h-screen py-32 px-10 mx-auto max-w-2/3"
  ...
  >
      ...
      >
        <li class="mr-2" role="presentation">
          <button
            ...
            "
            :class="
              queryParams == 'all' || queryParams == undefined
        ...
        <li class="mr-2" role="presentation" v-if="is_auth">
          <button
            ...
            "
            :class="
              queryParams == 'interested' ? 'border-blue-500 text-blue-500' : ''
            "
            id="dashboard-tab"
        ...
        <li class="mr-2" role="presentation">
          <button
            ...
            aria-selected="false"
            :class="
              queryParams == 'online' ? 'border-blue-500 text-blue-500' : ''
            "
          >
            Online
          </button>
        ...
        <li role="presentation">
          <button
            ...
            "
            :class="
              queryParams == 'Offline' ? 'border-blue-500 text-blue-500' : ''
            "
            id="contacts-tab"
    ...
    >
      ...
      <div
        v-else
        class="w-4 h-4 mt-1 border-4 border-blue-600 rounded-full loader"
      ></div>
    </button>
  </div>
</template>
