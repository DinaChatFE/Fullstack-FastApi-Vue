...
export default {
  ...
  methods: {
      ...
      CaregoryDataService.getAll()
        .then((response) => {
          ...
          response.data.forEach((value, index) => {
            if (this.$route.query.cate_id == value.id) {
              cats.push({
                id: value.id,
                text: value.name,
                selected: true,
    ...
    getList: function(id) {
      ...
      NewsDataService.get(id)
        .then(async (response) => {
          ...
          vm.form.thumbnail = response.data.thumbnail
        })
        .catch((e) => {
          console.log(e);
        });
    ...
    async handleSubmit(e) {
      ...
      await NewsDataService.update(this.currentList.id, this.form)
        .then((response) => {
