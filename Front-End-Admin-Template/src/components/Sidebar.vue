...
<template>
  <div class="flex">
    ...
    >
      ...
      <nav class="mt-10">
        <sidebar-item :active-class="activeClass" :inactive-class="inactiveClass" title="Dashboard" route-name="Dashboard"/>
        <sidebar-item :active-class="activeClass" :inactive-class="inactiveClass" title="Event" route-name="Event index"/>
